<div id="sideBar" class="w-[260px] hidden h-screen bg-gradient-to-tl from-secondary-100 to-primary-100 flex-col fixed p-[6px] items-start top-0 left-0 transition-all duration-200 ease-in-out z-10">
        ...
        <div class="profile flex items-center mb-10">
            <div class="w-12 h-12 bg-white flex justify-center items-center rounded-md">
                <img src="
                    <?php
                        ...
                        echo 'media/default-profile.png';
                    }
                    ?>
                " alt="User photo" class="w-12 h-12 rounded-md">
            </div>
            <div class="text-white ml-2"> 
                ...
                <a href="profile.php" class="labelSideBar hover:text-secondary-100">View profile</a>
            </div>
        </div>
        ...
        <a href="pet_list.php" class="flex items-center w-full hover:bg-secondary-100 hover:rounded-md mt-2">
                <div class="w-12 h-12 flex justify-center items-center rounded-md">
                    <img src="media/paw-solid.svg" alt="Pet list icon" class="w-8 h-8 filter-white">
                </div>
            <span class="labelSideBar ml-2 font-semibold text-white">Pet list</span>
        </a>
        <a href="appointment.php" class="flex items-center w-full hover:bg-secondary-100 hover:rounded-md mt-2">
                <div class="iconSideBar w-12 h-12 flex justify-center items-center rounded-md">
                    <img src="media/calendar-solid.svg" alt="Appointment icon" class="w-8 h-8 filter-white">
                </div>
        ...
        <a href="signout.php" class="flex items-center w-full border-t-2 mt-10">
            <div class="w-12 h-12 flex justify-center items-center rounded-md">
    ...
    <div class="header w-full h-[60px] shadow-lg flex items-center justify-end">
        ...
        <div class="absolute left-0 ml-[70px]">
            <span class="font-black text-transparent bg-gradient-to-tl from-secondary-100 to-primary-100 bg-clip-text">VETSYSTEM</span>
        </div>
        <div class="relative">
            <img src="media/envelope-solid.svg" alt="Message icon" class="w-6 h-6 filter-secondary-100 cursor-pointer mr-4">
            <div class="w-3 h-3 rounded-full bg-red-500 absolute top-0 right-0 mr-2 mt-[-4px] flex justify-center items-center">
                <p class="text-white text-[10px]">1</p>
            </div>
        </div>
        <div class="relative">
            <img src="media/bell-solid.svg" alt="Notification icon"  class="w-6 h-6 filter-secondary-100 cursor-pointer mr-5 sm:mr-2">
            <div class="w-3 h-3 rounded-full bg-red-500 absolute top-0 right-0 mr-4 sm:mr-1 mt-[-4px] flex justify-center items-center">
                <p class="text-white text-[10px]">1</p>
            </div>
        </div>
        <div class="w-[60px] h-[60px] bg-transparent justify-center items-center cursor-pointer mr-5 hidden sm:flex">
            <a href="profile.php"><img src="
                <?php
                    if(isset($_SESSION['idLogin'])) {
                    echo $_SESSION['profilePic'];
                } else {
                ...
                ?>
            " alt="Profile" class="w-8 h-8 rounded-md"></a>
        </div>
    </div>